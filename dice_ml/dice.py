...
class Dice(ExplainerBase):
    ...
    def __init__(self, data_interface, model_interface, method="random",constraints=False, **kwargs):
        """Init method
        ...
        """
        self.decide_implementation_type(data_interface, model_interface, method,constraints, **kwargs)

    def decide_implementation_type(self, data_interface, model_interface, method,constraints, **kwargs):
        ...
        self.__class__ = decide(model_interface, method,constraints)
...
def decide(model_interface, method, constraints=False):
    """Decides DiCE implementation type.
    ...
    if method == SamplingStrategy.Random:
        ...
        if model_interface.backend == BackEndTypes.Tensorflow1:
            ...
            # PyTorch backend
            if constraints:
                from dice_ml.explainer_interfaces.dice_pytorch_constraints import DicePyTorchConstraints
                return DicePyTorchConstraints
